...
champFilePath = '_internal/Champion_abilities.txt'
...
class MainWindow2(QtWidgets.QMainWindow):
    ...
    def show_results(self):
        ...
        pixmap = QPixmap(f'_internal\Roles\{role}.png')
        ...
        self.display_image(f'_internal\Images\{self.champ}.png')
        ...
        pixmapSpell1 = QPixmap(f'_internal\SummonerSpells\{sumSpell1}.png')
        ...
        pixmapSpell2 = QPixmap(f'_internal\SummonerSpells\{sumSpell2}.png')
        ...
        pixmapMainRune = QPixmap(f'_internal\Runes\{rune1}\{primaryRune}.png')
        ...
        pixmapSecondaryRune = QPixmap(f'_internal\Runes\{rune2}.png')
        ...
        pixmapPrimaryRune1 = QPixmap(f'_internal\Runes\{rune1}\{runes[0]}.png')
        ...
        pixmapPrimaryRune2 = QPixmap(f'_internal\Runes\{rune1}\{runes[1]}.png')
        ...
        pixmapPrimaryRune3 = QPixmap(f'_internal\Runes\{rune1}\{runes[2]}.png')
        ...
        pixmapSecondaryRune1 = QPixmap(f'_internal\Runes\{rune2}\{runes[3]}.png')
        ...
        pixmapSecondaryRune2 = QPixmap(f'_internal\Runes\{rune2}\{runes[4]}.png')
        ...
        pixmapShard1 = QPixmap(f'_internal\Runes\{shards[0]}.png')
        ...
        pixmapShard2 = QPixmap(f'_internal\Runes\{shards[1]}.png')
        ...
        pixmapShard3 = QPixmap(f'_internal\Runes\{shards[2]}.png')
        ...
        extractAbilityDescriptionFromFile("_internal\Champion_abilities.txt", self.champ)

        pixmapQ = QPixmap(f'_internal\Abilities\{self.champ}Q.png')
        ...
        pixmapW = QPixmap(f'_internal\Abilities\{self.champ}W.png')
        ...
        pixmapE = QPixmap(f'_internal\Abilities\{self.champ}E.png')
        ...
        pixmapR = QPixmap(f'_internal\Abilities\{self.champ}R.png')
        ...
        pixmapP = QPixmap(f'_internal\passive\{self.champ}_P.png')
